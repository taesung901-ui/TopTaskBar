...
#define MyAppURL "https://github.com/taesung901-ui/TopTaskBar"
#define MyAppExeName "TopTaskBar.exe"
#define MyAppPublishDir "TopTaskBar\bin\Release\manual-publish\win-x64"
#define MyAppIconFile "TopTaskBar\TopTaskBar.ico"
